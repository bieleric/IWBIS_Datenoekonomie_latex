...
\chapter{Einleitung}
% * Einleitung
\input{Kapitel_Einleitung/Motivation.tex}
% * Ziel und Methodik
\input{Kapitel_Einleitung/Methodik.tex}

\chapter{Grundlagen}
% * Datenschutz
\input{Kapitel_Grundlagen/Datenschutz.tex}
% * Datenökonomie
\input{Kapitel_Grundlagen/Datenökonomie.tex}
% * Wert der Daten
\input{Kapitel_Grundlagen/Wert_der_Daten.tex}

\chapter{Fallstudie}
% * Erklärung zur Auswahl der Fallbeispiele
\input{Kapitel_Fallanalyse/Erklärung.tex}
% * Payback
\input{Kapitel_Fallanalyse/Payback.tex}
% * Kaufland
\input{Kapitel_Fallanalyse/Kaufland.tex}
% * BitaAboutMe
\input{Kapitel_Fallanalyse/BitsAboutMe.tex}
% * Datum
\input{Kapitel_Fallanalyse/Datum.tex}
% * Invisibly
\input{Kapitel_Fallanalyse/Invisibly.tex}

\chapter{Auswertung der Fallstudie}
\input{Kapitel_Diskussion/Ergebnisse.tex}
\input{Kapitel_Diskussion/Kategorisierung.tex}
\input{Kapitel_Diskussion/Diskussion.tex}
...
\input{Kapitel_Anlagen/Anlagen.tex}
